			...
			const struct hsm_action_item *hai, long hal_flags)
{
	...
	if (length > hai->hai_extent.length)
...
static const char *hsm_copytool_action2name(enum hsm_copytool_action a)
{
	switch  (a) {
